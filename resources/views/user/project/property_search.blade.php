    ...
    <ul class="row">
      ...
      <li class="col-lg-4 col-md-6">
        <div class="property_box wow fadeInUp">
          ...
          <div class="property_location"><i class="fas fa-map-marker-alt" aria-hidden="true"></i> {{ $row->name }} <span class="float-right text-secondary">|<b>{{ $row->subcategory_name }}</b>|</span></div>
          <div class="rent_info">
